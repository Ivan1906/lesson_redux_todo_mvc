...
function AddTodo({onKeyDown}) {
  return (<input type="text" onKeyDown={onKeyDown} placeholder="Add text Todo"/>);
}

const enhance = compose(setPropTypes({onKeyDown: PropTypes.func.isRequired}), defaultProps({
